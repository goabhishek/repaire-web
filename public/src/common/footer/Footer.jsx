      ...
      <footer>
        <div className='container grid2'>
          ...
          <div className='box'>
            ...
            <ul>
              <li>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dignissimos vitae necessitatibus, optio porro
                eius quam.
              </li>
              <li>Email: raipurxyz@gmail.com</li>
              <li>Phone: +198888888</li>
            </ul>
          </div>
        </div>
      </footer>
